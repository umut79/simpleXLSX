...
//error_reporting(E_ALL);	//Debug purpose
		...
		$passwd='4200';//PASSWORD;//self explanatory
		$charset='utf8';//charset keeps preferred character encoding 
		$port='3306';//self explanatory			
		$dateformat='Y-M-d-h-i-s-A';// will be appended to database backup file name eg:test_2016-Oct-25-10-30-54-AM.zip
		...
		$pageincluded=false;//in case this page is included from master page and jquery is already in master page
...
<div id="content">
	  <div class="container-fluid">
		...
		<div id="progresscontainerdiv" style="background-color:darkgray;position:relative;width:100%;height:30px;padding:1px 1px 1px 1px;border:1px solid black;">
			<div id="progressdiv" style="background-color:#FBAC06;position:relative;width:0%;height:30px;">
			</div>
